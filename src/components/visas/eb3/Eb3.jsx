...
const Eb3 = ({ darkMode, isMenuShown, blue }) => {
  return (
    <Section
      darkMode={darkMode}
      isMenuShown={isMenuShown}
      blue={blue}
      title="EB-3 Visa: Skilled Workers, Professionals, and Other Workers"
      subtitle="The EB-3 visa is designed to address the diverse needs of the U.S. labor market by providing avenues for skilled workers, professionals, and other workers."
    >
              ...
              <div className="flex flex-col gap-4">
                <div className="flex  gap-2 ">
                  ...
                  <div className="">
                    ...
                    The EB-3A visa is for skilled workers with at least two
                    years of job experience or training. Employers can sponsor
                    foreign workers with specific skills or expertise that are
                ...
                <div className="flex  gap-2 ">
                  ...
                  <div className="">
                    ...
                    Description: The EB-3B visa is for professionals with a U.S.
                    baccalaureate degree or a foreign equivalent degree that is
                    typically required for the profession. It is suitable for
                    individuals seeking professional-level positions in the
                    United States.
                  </div>
                </div>
                <div className="flex  gap-2 ">
                  ...
                  <div className="">
                    ...
                    The EB-3C visa is for unskilled workers with less than two
                    years of job experience or training. This category addresses
                    the need for workers in positions that do not require
                    advanced skills or education.
                  </div>
                </div>
              </div>
            </div>
