...
const Eb1 = ({ darkMode, isMenuShown, blue }) => {
  return (
    <Section
      darkMode={darkMode}
      ...
      subtitle="The EB-1 visa is designed for priority workers who possess extraordinary abilities, outstanding achievements, or hold high-level executive or managerial positions in multinational companies. This category is intended for individuals who have demonstrated exceptional expertise in their fields.
      "
    >
              ...
              <div className="flex flex-col gap-4">
                <div className="flex  gap-2 ">
                  ...
                  <div className="">
                    ...
                    The EB-1A visa is for individuals with extraordinary
                    abilities in sciences, arts, education, business, or
                    athletics. Extraordinary ability is proven through sustained
                    national or international acclaim, with evidence of
                ...
                <div className="flex  gap-2 ">
                  ...
                  <div className="">
                    ...
                    The EB-1B visa targets internationally recognized professors
                    and researchers. Applicants must showcase outstanding
                    achievements in their academic or research careers,
                    including a minimum of three years of experience.
                  </div>
                </div>
                <div className="flex  gap-2 ">
                  <div className="flex gap-2">
                  ...
                  <div className="">
                    ...
                    The EB-1C visa facilitates the transfer of multinational
                    executives and managers who have been employed for at least
                    one of the preceding three years by the overseas affiliate,
                    parent, subsidiary, or branch of the U.S. employer. This
                    category is crucial for multinational corporations seeking
                    to bring key personnel to the United States.
                  </div>
                </div>
              </div>
            </div>
